                ...
                <div className="max-w-5xl mx-auto card p-7 sm:p-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="bg-surface-900 rounded-2xl border border-surface-800 p-6">
                            ...
                            <a
                                href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP}?text=Hi!%20I%20want%20a%20project%20quote%20between%20${encodeURIComponent(formatInr(estimate.min))}%20and%20${encodeURIComponent(formatInr(estimate.max))}.`}
                                target="_blank"
