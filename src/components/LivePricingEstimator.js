                ...
                <div className="max-w-5xl mx-auto card p-7 sm:p-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="bg-surface-900 rounded-2xl border border-surface-800 p-6">
                            ...
                            <a
                                href={`https://wa.me/919423699549?text=Hi%20mv%20webservice%20i%20need%20website%20for____%20(Quote%20between%20${encodeURIComponent(formatInr(estimate.min))}%20and%20${encodeURIComponent(formatInr(estimate.max))})`}
                                target="_blank"
