                ...
                <div className="max-w-5xl mx-auto card p-7 sm:p-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="bg-surface-900 rounded-2xl border border-surface-800 p-6">
                            ...
                            <a
                                href={`https://api.whatsapp.com/send?phone=919423699549&text=${encodeURIComponent(`Hi mv webservice i need website for____ (Quote between ${formatInr(estimate.min)} and ${formatInr(estimate.max)})`)}`}
                                target="_blank"
